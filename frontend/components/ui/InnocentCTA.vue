<template>
  <button class="grid grid-flow-col place-items-center gap-2 py-2 px-3 border border-transparent rounded-xl duration-300 bg-c-green-3 text-c-black hover:bg-green-900 hover:border-green-900 hover:text-white" aria-label="Vote innocent">
    <span>Innocent</span>
