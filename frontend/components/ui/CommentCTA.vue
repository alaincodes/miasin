...
onMounted(() => {
  randomNumber.value = Math.floor(Math.random() * 500) + 1
})
</script>
<template>
  <button
    class="flex gap-2 items-center py-2 px-3 bg-c-black-darker border border-c-black-lighter rounded-xl duration-300 hover:border-white"
